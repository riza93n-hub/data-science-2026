...
Di dalam repositori ini, terdapat kumpulan berkas *notebook* (*.ipynb*) hasil praktikum saya dari Pertemuan 1 hingga Pertemuan 7. Isi di dalamnya mencakup fondasi dasar bahasa Python, teknik membersihkan data dari berbagai macam error, cara menyajikan data ke dalam bentuk grafik visual yang menarik, hingga tahap akhir berupa penyusunan jalur persiapan data (*preprocessing pipeline*) sebelum dimasukkan ke dalam model kecerdasan buatan (*Machine Learning*). Seluruh tugas di sini dirancang terstruktur agar kodenya dapat dijalankan ulang dari atas ke bawah tanpa error.

---

## 📁 Daftar Pertemuan & Topik Praktikum

Berikut adalah rincian materi yang telah saya pelajari dan selesaikan. Anda dapat langsung membuka setiap berkas *notebook* melalui tautan di bawah ini:
...
* **Komputasi Statistik & Machine Learning:** SciPy, scikit-learn.

---

## 🚀 Cara Menjalankan Notebook

Anda dapat menguji atau menjalankan seluruh kode program di repositori ini dengan dua cara mudah:

### Cara 1: Menggunakan Google Colab (Paling Direkomendasikan)
1. Buka salah satu file *notebook* di atas lewat GitHub.
2. Salin tautan (*URL*) dari peramban Anda.
3. Buka [Google Colab](https://colab.research.google.com/), pilih menu **GitHub**, lalu tempelkan tautan tadi untuk langsung membukanya secara online tanpa instalasi.

### Cara 2: Menjalankan Secara Lokal di Komputer
1. Unduh atau klon repositori ini ke komputer Anda:
   ```bash
   git clone [https://github.com/riza93n-hub/data-science-2026](https://github.com/riza93n-hub/data-science-2026)
